...
public class PersonalTaskController {
    ...
    // New endpoint for pinned personal tasks
    @GetMapping("/pinned")
    public ResponseEntity<List<PersonalTaskDTO>> getPinnedPersonalTasks(Authentication authentication) {
        ...
        List<PersonalTaskDTO> pinnedTaskDTOs = pinnedTasks.stream()
                .map(PersonalTaskDTO::new)
                .collect(Collectors.toList());
        return ResponseEntity.ok(pinnedTaskDTOs);
    }
}